...
@section('breadcrumb')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Creating new link</li>
        </ol>
    </nav>
@endsection
@section('content')
    <form class="row g-3" action="{{ route('admin.link.store') }}" method="POST">
        @csrf
        <div class="col-12">
        ...
        <div class="col-md-6">
            ...
            <input type="number" name="max_views" value="0" class="form-control" id="max_views">
            @error('max_views')
            <div class="text-danger">{{ $message }}</div>
            @enderror
        </div>
        <div class="col-md-4">
            <div class="form-group">
                ...
                <div class="input-group date" id="id_3">
                    <input type="text" name="expired_at" value="00:05:00" class="form-control" placeholder="End time"
